!(function (e, t) {
            ...
            U.forEach(t, function (t, o) {
              !0 ===
                (!(U.isUndefined(t) || null === t) &&
                  a.call(n, t, U.isString(o) ? o.trim() : o, r, h)) &&
                e(t, r ? r.concat(o) : [o]);
            }),
            d.pop();
        }
        ...
        return new Promise(function (t, n) {
          ...
          if (
            (u.open(
              ...
              G(l, e.params, e.paramsSerializer),
              !0
            ),
            (u.timeout = e.timeout),
            "onloadend" in u
            ...
            (u.onabort = function () {
              u &&
                (n(new F("Request aborted", F.ECONNABORTED, e, u)), (u = null));
            }),
            (u.onerror = function () {
  ...
  var Re = function (e) {
    for (
      ...
      o < r && ((t = e[o]), !(n = U.isString(t) ? Se[t.toLowerCase()] : t));
      o++
    );
    if (!n) {
      if (!1 === n)
